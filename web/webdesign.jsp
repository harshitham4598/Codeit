<%-- 
    Document   : webdesign
    Created on : Dec 26, 2019, 10:01:34 PM
    Author     : user
--%>
                ...
                <div id="carousel-slider" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="img/www.jpg" class="img-responsive" alt="">
                        ...
                        <div class="item">
                            <img src="img/www2.jpg" class="img-responsive" alt="">
                            <div class="carousel-caption">
                                <div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="1.0s">
                                    <h2>Fetch your Web developer</h2>
                                </div>
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.6s">
...
<!--    <center><ul><li class="grey"><a href="#" class="button">Sign Up</a></li></ul></center><br>-->
    ...
    <center><ul><li class="grey"> <input type="submit" value="Sign Up" class="button" onclick="javascript:window.location='available_coder.jsp?user_id=Web_Development'"></li></ul> </center>
