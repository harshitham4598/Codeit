<%-- 
    Document   : android
    Created on : Dec 26, 2019, 8:33:06 PM
    Author     : user
--%> 
                ...
                <div id="carousel-slider" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="img/android1.jpg" class="img-responsive" alt="">
                            <div class="carousel-caption ">
                                <div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.3s">
                                    <h2><span>Android Developer</span></h2>
                                </div>
                        ...
                        <div class="item">
                            <img src="img/androoid2.jpg" class="img-responsive" alt="">
                            <div class="carousel-caption">
                                <div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="1.0s">
                                    <h2>Fetch your Android developer</h2>
                                </div>
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.6s">
                    ...
                    <!--        <div class="col-md-4 and ">
                              <div class="wow bounceIn" data-wow-offset="0" data-wow-delay="0.8s">
                                <div class="align-center">
                                  ...
                                  <div class="ficon">
                                    <a href="" alt="" style="visibility:hidden">Learn more</a>
                                  </div>
                                </div>
                              </div>
                            </div>-->
...
<!--    <center><ul><li class="grey"><a href="#" class="button">Sign Up</a></li></ul></center><br>-->
  ...
  <center><ul><li class="grey"> <input type="submit" value="Sign Up" class="button" onclick="javascript:window.location='available_coder.jsp?user_id=Android_Development'"></li></ul> </center>
